                    ...
                    <div class="col-12">
                        <div class="card card-primary">
                            <div class="card-header" style="background-color: #dc3545; color: #ffffff;">
                                <h3 class="card-title">Add New Sales Center Address</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <div class="col-6">
                                    <form role="form" method="POST" action="{{ URL::to('portal/sales-center/store') }}"
                                        ...
                                        <div class="card-body">
                                            <div class="form-group{{ $errors->has('sales_center_address') ? ' has-error' : '' }}">
                                                ...
                                                <textarea rows="4" class="form-control requiredOL"
                                                          ...
                                                          placeholder="Enter address">{{ old('sales_center_address') }}</textarea>
                                            ...
                                            <div class="form-group{{ $errors->has('sales_center_city') ? ' has-error' : '' }}">
                                                ...
                                                <input type="text" class="form-control requiredOL"
                                                       ...
                                                       placeholder="Enter city" value="{{ old('sales_center_city') }}">
                                            ...
                                            <div class="form-group{{ $errors->has('sales_center_working_hours') ? ' has-error' : '' }}">
                                                ...
                                                <input type="text" class="form-control requiredOL"
                                                       ...
                                                       value="{{ old('sales_center_working_hours') }}">
                                            ...
                                            <div class="form-group{{ $errors->has('sales_center_working_days') ? ' has-error' : '' }}">
                                                ...
                                                <input type="text" class="form-control requiredOL"
                                                       ...
                                                       value="{{ old('sales_center_working_days') }}">
                                            ...
                                            <div class="form-group{{ $errors->has('sales_center_status') ? ' has-error' : '' }}">
                                                ...
                                                <select class="form-control requiredOL" name="sales_center_status"
                                                    ...
                                                    <option value="Active"
                                                            @if('Active' == old('sales_center_status')) selected="selected" @endif>
                                                        Active
                                                    </option>
                                                    <option value="Inactive"
                                                            @if('Inactive' == old('sales_center_status')) selected="selected" @endif>
                                                        Inactive
                                                    </option>
                                                </select>
