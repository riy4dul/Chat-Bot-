                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <div class="col-6">
                                    <form role="form" method="POST" action="{{ URL::to('portal/brand/update') }}"
                                        ...
                                        <div class="card-body">
                                            <div class="form-group{{ $errors->has('brand_name') ? ' has-error' : '' }}">
                                                ...
                                                <select class="form-control requiredOL" id="brand_name" name="brand_name">
                                                    <option value="">-- Select --</option>
                                                    @foreach($carBrandList AS $carBrand)
                                                        <option value="{{ $carBrand->car_brands_id }}"@if($carBrand->car_brands_id == $data->brand_name) selected="selected" @endif>{{ $carBrand->car_brands_name }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group{{ $errors->has('brand_model') ? ' has-error' : '' }}">
                                                ...
                                                <input type="text" class="form-control requiredOL" id="brand_model"
                                                       name="brand_model"
                                                       placeholder="Enter model name" value="{{ $data->brand_model }}">
                                            ...
                                            <div class="form-group{{ $errors->has('brand_price') ? ' has-error' : '' }}">
                                                ...
                                                <input type="text" class="form-control requiredOL" id="brand_price"
                                                       name="brand_price"
                                                       placeholder="Enter price" value="{{ $data->brand_price }}" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                                            ...
                                            <div class="form-group{{ $errors->has('brand_image_link') ? ' has-error' : '' }}">
                                                ...
                                                <input type="text" class="form-control requiredOL" id="brand_image_link"
                                                       ...
                                                       placeholder="Enter image link" value="{{ $data->brand_image_link }}">
                                            ...
                                            <div class="form-group{{ $errors->has('brand_description') ? ' has-error' : '' }}">
                                                <label for="brand_description">Description<span
                                                            class="mark">*</span></label>
                                                <textarea class="form-control requiredOL" rows="4" name="brand_description"
                                                          id="brand_description"
                                                          placeholder="Enter description">{{ $data->brand_description }}</textarea>
                                            ...
                                            <div class="form-group{{ $errors->has('brand_specifications') ? ' has-error' : '' }}">
                                                <label for="brand_specifications">Specification(Website URL or Facebook URL)<span
                                                            class="mark">*</span></label>
                                                <input type="text" class="form-control requiredOL"  name="brand_specifications"
                                                          id="brand_specifications"
                                                          placeholder="Enter specification" value="{{ $data->brand_specifications }}">
                                            ...
                                            <div class="form-group{{ $errors->has('brand_status') ? ' has-error' : '' }}">
                                                ...
                                                <select class="form-control requiredOL" name="brand_status"
                                                        id="brand_status">
                                                    <option value="Active"
                                                            @if('Active' == $data->brand_status) selected="selected" @endif>
                                                        Active
                                                    </option>
                                                    <option value="Inactive"
                                                            @if('Inactive' == $data->brand_status) selected="selected" @endif>
                                                        Inactive
                                                    </option>
                                                </select>
                                            ...
                                            <div class="form-group{{ $errors->has('brand_latest_cars') ? ' has-error' : '' }}">
                                                ...
                                                <select class="form-control requiredOL" name="brand_latest_cars"
                                                    ...
                                                    <option value="Yes"
                                                            @if('Yes' == $data->brand_latest_cars) selected="selected" @endif>
                                                        Yes
                                                    </option>
                                                    <option value="No"
                                                            @if('No' == $data->brand_latest_cars) selected="selected" @endif>
                                                        No
                                                    </option>
                                                </select>
                                            ...
                                            <div class="form-group{{ $errors->has('brand_top_seller_cars') ? ' has-error' : '' }}">
                                                ...
                                                <select class="form-control requiredOL" name="brand_top_seller_cars"
                                                    ...
                                                    <option value="Yes"
                                                            @if('Yes' == $data->brand_top_seller_cars) selected="selected" @endif>
                                                        Yes
                                                    </option>
                                                    <option value="No"
                                                            @if('No' == $data->brand_top_seller_cars) selected="selected" @endif>
                                                        No
                                                    </option>
                                                </select>
                                            ...
                                            <div class="form-group{{ $errors->has('brand_gallery_cars') ? ' has-error' : '' }}">
                                                ...
                                                <select class="form-control requiredOL" name="brand_gallery_cars"
                                                    ...
                                                    <option value="Yes"
                                                            @if('Yes' == $data->brand_gallery_cars) selected="selected" @endif>
                                                        Yes
                                                    </option>
                                                    <option value="No"
                                                            @if('No' == $data->brand_gallery_cars) selected="selected" @endif>
                                                        No
                                                    </option>
                                                </select>
