                    ...
                    <div class="col-12">
                        <div class="card card-primary">
                            <div class="card-header" style="background-color: #dc3545; color: #ffffff;">
                                <h3 class="card-title">Update Loan Info</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <div class="col-6">
                                    <form role="form" method="POST" action="{{ URL::to('portal/loan-info/update') }}"
                                          enctype="multipart/form-data" id="brand-form">
                                        @csrf
                                        <input type="hidden" name="loan_info_id" value="{{ $data->loan_info_id }}">
                                        <div class="card-body">
                                            <div class="form-group{{ $errors->has('loan_info_name') ? ' has-error' : '' }}">
                                                ...
                                                <input type="text" class="form-control requiredOL" id="loan_info_name"
                                                       name="loan_info_name"
                                                       placeholder="Enter name" value="{{ $data->loan_info_name }}">
                                            ...
                                            <div class="form-group{{ $errors->has('loan_info_designation') ? ' has-error' : '' }}">
                                                ...
                                                <input type="text" class="form-control requiredOL" id="loan_info_designation"
                                                       ...
                                                       placeholder="Enter designation" value="{{ $data->loan_info_designation }}">
                                            ...
                                            <div class="form-group{{ $errors->has('loan_info_phone') ? ' has-error' : '' }}">
                                                ...
                                                <input type="text" class="form-control requiredOL" id="loan_info_phone"
                                                       ...
                                                       placeholder="Enter phone number" maxlength="13" value="{{ $data->loan_info_phone }}" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                                            ...
                                            <div class="form-group{{ $errors->has('loan_info_status') ? ' has-error' : '' }}">
                                                ...
                                                <select class="form-control requiredOL" name="loan_info_status"
                                                        id="loan_info_status">
                                                    <option value="Active"
                                                            @if('Active' == $data->loan_info_status) selected="selected" @endif>
                                                        Active
                                                    </option>
                                                    <option value="Inactive"
                                                            @if('Inactive' == $data->loan_info_status) selected="selected" @endif>
                                                        Inactive
                                                    </option>
                                                </select>
