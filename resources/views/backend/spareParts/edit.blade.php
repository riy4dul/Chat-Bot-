                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <div class="col-6">
                                    <form role="form" method="POST" action="{{ URL::to('portal/spare-parts/update') }}"
                                          enctype="multipart/form-data" id="brand-form">
                                        @csrf
                                        <input type="hidden" name="spare_parts_id" value="{{ $data->spare_parts_id }}">
                                        <div class="card-body">
                                            <div class="form-group{{ $errors->has('spare_parts_brand') ? ' has-error' : '' }}">
                                                ...
                                                <select class="form-control requiredOL" id="spare_parts_brand" name="spare_parts_brand">
                                                    <option value="">-- Select --</option>
                                                    @foreach($carBrandList AS $carBrand)
                                                        <option value="{{ $carBrand->car_brands_id }}"@if($carBrand->car_brands_id == $data->spare_parts_brand) selected="selected" @endif>{{ $carBrand->car_brands_name }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group{{ $errors->has('spare_parts_stock') ? ' has-error' : '' }}">
                                                ...
                                                <select class="form-control requiredOL" name="spare_parts_stock"
                                                    ...
                                                    <option value="Yes"
                                                            @if('Yes' == $data->spare_parts_stock) selected="selected" @endif>
                                                        Yes
                                                    </option>
                                                    <option value="No"
                                                            @if('No' == $data->spare_parts_stock) selected="selected" @endif>
                                                        No
                                                    </option>
                                                </select>
                                            ...
                                            <div class="form-group{{ $errors->has('spare_parts_price') ? ' has-error' : '' }}">
                                                ...
                                                <input type="text" class="form-control requiredOL"
                                                       ...
                                                       value="{{ $data->spare_parts_price }}" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                                            ...
                                            <div class="form-group{{ $errors->has('spare_parts_status') ? ' has-error' : '' }}">
                                                ...
                                                <select class="form-control requiredOL" name="spare_parts_status"
                                                    ...
                                                    <option value="Active"
                                                            @if('Active' == $data->spare_parts_status) selected="selected" @endif>
                                                        Active
                                                    </option>
                                                    <option value="Inactive"
                                                            @if('Inactive' == $data->spare_parts_status) selected="selected" @endif>
                                                        Inactive
                                                    </option>
                                                </select>
