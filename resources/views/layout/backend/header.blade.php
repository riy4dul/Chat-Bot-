<nav class="main-header navbar navbar-expand bg-danger navbar-light border-bottom">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
            <a role="button" class="nav-link" href="javascript:void(0);" data-toggle="modal" data-target=".logout">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background: #dc3545 !important;">
                <h5 class="modal-title" id="exampleModalLabel" style="color: #fff;text-align: center;">Are you sure you
                    want to logout?</h5>
            ...
            <div class="modal-footer">
                <button type="button"
                        class="btn btn-outline-default pull-left"
                        data-dismiss="modal"><i
                            class="fa fa-close"></i>&nbsp;No, not sure
                </button>
                <a type="button"
                   class="btn btn-outline-success" href="{{ URL::to('/logout') }}"><i
